...
{
	public class Sidemenu : FrameLayout
	{
		bool opened;
		int contentOffsetX;
		...
		public Sidemenu (Context context, IAttributeSet attrs) :
			base (context, attrs)
		{
			Initialize ();
		}

		public Sidemenu (Context context, IAttributeSet attrs, int defStyle) :
		...
		View ContentView {
			get {
                return FindViewById (Resource.Id.content_frame);
			}
		}

		View MenuView {
			get {
				return FindViewById (Resource.Id.left_drawer);
			}
		}
		...
		protected override void DispatchDraw (Android.Graphics.Canvas canvas)
		{
			base.DispatchDraw (canvas);
                ...
                Home.Closemenu.Visibility = opened ? ViewStates.Visible : ViewStates.Invisible;
