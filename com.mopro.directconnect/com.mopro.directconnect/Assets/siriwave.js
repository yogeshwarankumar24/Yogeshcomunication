...
SiriWaveCurve.prototype.draw = function() {
	...
	ctx.lineWidth = 15;//this.definition.lineWidth;
...
{ attenuation: -2, lineWidth: 4, opacity: 0.1 },
{ attenuation: -6, lineWidth: 3, opacity: 0.2 },
...
function SiriWave(opt) {
    ...
    //this.cache.width2 = 350;
	this.cache.width4 = this.cache.width / 4;
    //this.cache.width4 = 250;
